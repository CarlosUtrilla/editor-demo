...
__export(src_exports, {
    ...
    AlignLeftIcon: function() {
        return AlignLeftIcon;
    },
    AlignRightIcon: function() {
    ...
    ColorIconPicker: function() {
        return ColorIconPicker;
    },
    ColorPicker: function() {
        return ColorPicker;
    },
    CompleteMenu: function() {
        return CompleteMenu;
    },
    CropIcon: function() {
        return CropIcon;
    ...
    MoveToolIcon: function() {
        return MoveToolIcon;
    },
    MoveableData: function() {
        return MoveableData;
    },
    MoveableMananger: function() {
        return MoveableManager;
    },
    MoveablePrintArea: function() {
        return MoveablePrintArea;
    },
    NumberBox: function() {
        return NumberBox;
    },
    ...
    PolygonIcon: function() {
        return PolygonIcon;
    },
    Popup: function() {
        return Popup;
    },
    PrintAreaIcon: function() {
        return PrintAreaIcon;
    },
    PrintAreaMenu: function() {
        return PrintAreaMenu;
    },
    RectIcon: function() {
        return RectIcon;
    },
    ...
    TabInputBox: function() {
        return TabInputBox;
    },
    TextBox: function() {
        return TextBox;
    },
    TextColorIcon: function() {
    ...
    connectEditorProps: function() {
        return connectEditorProps;
    },
    default: function() {
        return src_default;
    },
    ...
    getParnetScenaElement: function() {
        return getParnetScenaElement;
    },
    getScenaAttrs: function() {
        return getScenaAttrs;
    },
    inRange: function() {
        return inRange;
    },
    isDivInsideAnother: function() {
        return isDivInsideAnother;
    },
    isNumber: function() {
        return isNumber;
    },
    isScenaElement: function() {
        return isScenaElement;
    },
    isScenaFunction: function() {
        return isScenaFunction;
    },
    isScenaFunctionElement: function() {
        return isScenaFunctionElement;
    },
...
var Anchor = /*#__PURE__*/ function(Input) {
    _inherits(Anchor, Input);
    var _super = _create_super(Anchor);
    function Anchor() {
        ...
        _this.onClick = function(e) {
            var target = e.target;
            var indexes = target.getAttribute("data-anchor-index");
            if (!indexes) {
                return;
            }
            var origin = indexes.split(",").map(function(v) {
                return parseFloat(v) * 50;
            });
            _this.props.onChange(origin);
        };
        return _this;
    }
    _create_class(Anchor, [
        {
            key: "render",
            value: function render() {
                var origin = this.state.origin.map(function(v) {
                    return Math.min(100, Math.max(0, Math.round(v / 50) * 50));
                });
                return /* @__PURE__ */ React37.createElement("div", {
                    className: prefix("anchor-input")
                }, /* @__PURE__ */ React37.createElement("div", {
                    className: prefix("anchor-input-background"),
                    onClick: this.onClick
                }, VERTICAL_DIRECTIONS.map(function(v, i) {
                    return HORIZONTAL_DIRECTIONS.map(function(h, j) {
                        var classNames = [];
                        if (v) {
                            classNames.push("anchor-".concat(v));
                        }
                        if (h) {
                            classNames.push("anchor-".concat(h));
                        }
                        if (origin[0] === j * 50 && origin[1] === i * 50) {
                            classNames.push("anchor-selected");
                        }
                        return /* @__PURE__ */ React37.createElement("div", {
                            key: "dir".concat(h, "-").concat(v),
                            className: prefix.apply(void 0, [
                                "anchor-control"
                            ].concat(_to_consumable_array(classNames))),
                            "data-anchor-index": "".concat(j, ",").concat(i)
                        });
                    });
                })));
            }
...
var import_keycon2 = require("keycon");
var import_utils18 = require("@daybrush/utils");
var TextBox = /*#__PURE__*/ function(Input) {
    _inherits(TextBox, Input);
    var _super = _create_super(TextBox);
    function TextBox() {
        ...
        _this.onInput = function(e) {
            var ev = e.nativeEvent || e;
            if (!(0, import_utils18.isUndefined)(ev.data)) {
                return;
            }
            _this.props.onChange(_this.input.current.value);
        };
        ...
        _this.onKeyUp = function(e) {
            ...
            e.stopPropagation();
            if ((0, import_keycon2.getKey)(e.keyCode) === "enter") {
    ...
    _create_class(TextBox, [
        {
            key: "render",
            value: function render() {
                return /* @__PURE__ */ React38.createElement("input", _object_spread_props(_object_spread({
                    ref: this.input,
        ...
        },
        {
            key: "setValue",
            value: function setValue(value) {
                this.input.current.value = "".concat((0, import_utils18.isUndefined)(value) ? "" : value);
            }
        }
    ]);
    return TextBox;
...
// src/Editor/Inputs/ColorBox.tsx
var ColorBox = /*#__PURE__*/ function(Input) {
    _inherits(ColorBox, Input);
    var _super = _create_super(ColorBox);
    function ColorBox() {
        _class_call_check(this, ColorBox);
        var _this;
        _this = _super.call.apply(_super, [
            this
        ].concat(Array.prototype.slice.call(arguments)));
        _this.inputAttributes = {};
        _this.colorInput = React39.createRef();
        _this.textInput = React39.createRef();
        _this.state = {
            display: "none",
            color: "#fff"
        };
        ...
        _this.onClick = function(e) {
            _this.textInput.current.input.current.focus();
        };
        return _this;
    }
    _create_class(ColorBox, [
        {
            key: "render",
            value: function render() {
                return /* @__PURE__ */ React39.createElement("div", {
                    className: prefix("color-input"),
                    ref: this.input,
                    onBlur: this.onBlur
                    ...
                    onClick: this.onClick
                }), /* @__PURE__ */ React39.createElement(TextBox, {
                    ref: this.textInput,
                    onChange: this.onChange,
                    inputProps: {
                        onFocus: this.onFocus
        ...
        },
        {
            ...
            value: function renderPicker() {
                ...
                }, /* @__PURE__ */ React39.createElement(ColorPicker, {
                    ref: this.colorInput,
                    onChange: this.onChange
                }));
            }
...
var LabelBox = /*#__PURE__*/ function(_React40_PureComponent) {
    _inherits(LabelBox, _React40_PureComponent);
    var _super = _create_super(LabelBox);
    function LabelBox() {
        _class_call_check(this, LabelBox);
        return _super.apply(this, arguments);
    }
    _create_class(LabelBox, [
        {
            key: "render",
            value: function render() {
                var _this_props = this.props, label = _this_props.label, type = _this_props.type;
                return /* @__PURE__ */ React40.createElement("div", {
                    className: prefix("tab-input", type)
                }, /* @__PURE__ */ React40.createElement("h3", null, label));
            }
        }
    ]);
    return LabelBox;
...
var NumberBox = /*#__PURE__*/ function(TextBox) {
    _inherits(NumberBox, TextBox);
    var _super = _create_super(NumberBox);
    function NumberBox() {
        _class_call_check(this, NumberBox);
        var _this;
        _this = _super.call.apply(_super, [
            this
        ].concat(Array.prototype.slice.call(arguments)));
...
var TabInputBox = /*#__PURE__*/ function(_React41_PureComponent) {
    _inherits(TabInputBox, _React41_PureComponent);
    var _super = _create_super(TabInputBox);
    function TabInputBox() {
        _class_call_check(this, TabInputBox);
        var _this;
        _this = _super.call.apply(_super, [
            this
        ].concat(Array.prototype.slice.call(arguments)));
        _this.input = React41.createRef();
        return _this;
    }
    _create_class(TabInputBox, [
        {
            key: "render",
            value: function render() {
                var _this_props = this.props, label = _this_props.label, type = _this_props.type, _this_props_props = _this_props.props, props = _this_props_props === void 0 ? {} : _this_props_props, _this_props_inputProps = _this_props.inputProps, inputProps = _this_props_inputProps === void 0 ? {} : _this_props_inputProps, InputType = _this_props.input, onChange = _this_props.onChange, value = _this_props.value, updateValue = _this_props.updateValue;
                return /* @__PURE__ */ React41.createElement("div", {
                    className: prefix("tab-input", type)
                }, label && /* @__PURE__ */ React41.createElement("h3", null, label), /* @__PURE__ */ React41.createElement(InputType, _object_spread_props(_object_spread({
                    ref: this.input,
                    onChange: onChange
                }, props), {
...
var Popup = /*#__PURE__*/ function(_React42_PureComponent) {
    _inherits(Popup, _React42_PureComponent);
    var _super = _create_super(Popup);
    function Popup() {
        _class_call_check(this, Popup);
        var _this;
        _this = _super.call.apply(_super, [
            this
        ].concat(Array.prototype.slice.call(arguments)));
        _this.overlayElement = React42.createRef();
        _this.popupKeyManager = new KeyManager(_this.console);
        _this.onClick = function(e) {
            e.stopPropagation();
...
// src/Editor/Menu/KeyboardIcon.tsx
var KeyboardIcon = /*#__PURE__*/ function(Icon) {
    _inherits(KeyboardIcon, Icon);
    var _super = _create_super(KeyboardIcon);
    function KeyboardIcon() {
        _class_call_check(this, KeyboardIcon);
        var _this;
        _this = _super.call.apply(_super, [
            this
        ].concat(Array.prototype.slice.call(arguments)));
    ...
    _create_class(KeyboardIcon, [
        ...
        },
        {
            ...
            value: function renderPopup() {
                return ReactDOM.createPortal(/* @__PURE__ */ React43.createElement(Popup, {
                    editor: this.editor,
                    onClose: this.onClose
                }, /* @__PURE__ */ React43.createElement("h2", null, "Shortcuts"), /* @__PURE__ */ React43.createElement("ul", {
                    className: prefix("key-list")
                }, this.keyManager.keylist.map(function(param) {
                    var _param = _sliced_to_array(param, 2), keys = _param[0], description = _param[1];
                    return /* @__PURE__ */ React43.createElement("li", {
                        key: keys.join("+")
                    }, /* @__PURE__ */ React43.createElement("p", {
                        className: prefix("key-description")
                    }, description, " ", /* @__PURE__ */ React43.createElement("strong", null, keys.map(function(key) {
...
var AlignText = /*#__PURE__*/ function(Icon) {
    _inherits(AlignText, Icon);
    var _super = _create_super(AlignText);
    function AlignText() {
        _class_call_check(this, AlignText);
        var _this;
        _this = _super.call.apply(_super, [
            this
        ].concat(Array.prototype.slice.call(arguments)));
    ...
    _create_class(AlignText, [
        {
            ...
            value: function renderIcon() {
                ...
                if (selected) {
                    var IconSelected = selected.children;
                    return /* @__PURE__ */ React44.createElement(IconSelected, {
                        editor: this.editor
                    });
                }
                return /* @__PURE__ */ React44.createElement("i", {
...
AlignText.id = subMenu2.map(function(s) {
    return s.id;
});
// src/Editor/Viewport/MoveablePrintArea.tsx
var import_react = __toESM(require("react"));
var MoveablePrintArea = /*#__PURE__*/ function(_import_react_default_PureComponent) {
    _inherits(MoveablePrintArea, _import_react_default_PureComponent);
    var _super = _create_super(MoveablePrintArea);
    function MoveablePrintArea() {
        _class_call_check(this, MoveablePrintArea);
        return _super.apply(this, arguments);
    }
    _create_class(MoveablePrintArea, [
        {
            key: "render",
            value: function render() {
                var printAreas = this.props.printAreas;
                return /* @__PURE__ */ import_react.default.createElement(import_react.default.Fragment, null, printAreas.length > 0 && /* @__PURE__ */ import_react.default.createElement("svg", {
                    width: "0",
                    height: "0"
                }, /* @__PURE__ */ import_react.default.createElement("defs", null, /* @__PURE__ */ import_react.default.createElement("clipPath", {
                    id: "printAreas"
                }, printAreas.map(function(p) {
                    var _p_frame = p.frame, top = _p_frame.top, left = _p_frame.left, width = _p_frame.width, height = _p_frame.height, transform = _p_frame.transform;
                    top = parseInt(top) + 1;
                    left = parseInt(left) + 1;
                    width = parseInt(width) + 2;
                    height = parseInt(height) + 2;
                    var topLeft = "".concat(left, ",").concat(top);
                    var topRight = "".concat(left + width, ",").concat(top);
                    var bottomRight = "".concat(left + width, ",").concat(top + height);
                    var bottomLeft = "".concat(left, ", ").concat(top + height);
                    if (transform) {
                        transform = Object.entries(transform).map(function(param) {
                            var _param = _sliced_to_array(param, 2), key = _param[0], value = _param[1];
                            return "".concat(key, "(").concat(value, ")");
                        });
                        transform = transform.join(" ");
                    }
                    return /* @__PURE__ */ import_react.default.createElement("polygon", {
                        key: p.id,
                        points: "".concat(topLeft, " ").concat(topRight, " ").concat(bottomRight, " ").concat(bottomLeft),
                        style: {
                            transform: transform,
                            transformOrigin: "".concat(left + width / 2, "px ").concat(top + height / 2, "px")
                        }
                    });
                })))));
            }
...
0 && (module.exports = {
    ...
    MoveableMananger: MoveableMananger,
    MoveablePrintArea: MoveablePrintArea,
    NumberBox: NumberBox,
    OvalIcon: OvalIcon,
    PolygonIcon: PolygonIcon,
    Popup: Popup,
    PrintAreaIcon: PrintAreaIcon,
    PrintAreaMenu: PrintAreaMenu,
    RectIcon: RectIcon,
    RedoIcon: RedoIcon,
    RoundRectIcon: RoundRectIcon,
    SelectBox: SelectBox,
    ShapesIcon: ShapesIcon,
    ShapesMenu: ShapesMenu,
    TabInputBox: TabInputBox,
    TextBox: TextBox,
    TextColorIcon: TextColorIcon,
    TextIcon: TextIcon,
    TextMenu: TextMenu,
    UnderlinedIcon: UnderlinedIcon,
    UndoIcon: UndoIcon,
    Viewport: Viewport,
    between: between,
    checkImageLoaded: checkImageLoaded,
    checkInput: checkInput,
    connectEditorProps: connectEditorProps,
    getContentElement: getContentElement,
    getId: getId,
    getIds: getIds,
    getParnetScenaElement: getParnetScenaElement,
    getScenaAttrs: getScenaAttrs,
    inRange: inRange,
    isDivInsideAnother: isDivInsideAnother,
    isNumber: isNumber,
    isScenaElement: isScenaElement,
    isScenaFunction: isScenaFunction,
    isScenaFunctionElement: isScenaFunctionElement,
